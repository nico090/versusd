...
#pragma warning restore CS4014
                    ...
                    // Forcing a blocking Gen2 GC.Collect() every ~1s here used to stall this exact
                    // thread (it also drives KcpServer.TickIncoming/TickOutgoing). A pause >= the
                    // kcp2k ConnectionTimeout (10s) reads to clients as every connection timing out
                    // at once right as CharSelect's spawn burst hits (see VersusD project memory
                    // "relay-lrm-migration"). Let the runtime GC manage itself instead.
                }
