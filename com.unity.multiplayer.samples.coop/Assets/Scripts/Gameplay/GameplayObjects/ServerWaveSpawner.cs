...
namespace Unity.BossRoom.Gameplay.GameplayObjects
{
    ...
    public class ServerWaveSpawner : NetworkBehaviour
    {
        ...
        List<GameObject> m_ActiveSpawns = new List<GameObject>();
        ...
        /// <summary>
        /// Spawn a networked prefab clone.
        /// </summary>
        ...
        bool IsRoomAvailableForAnotherSpawn()
        {
            ...
            m_ActiveSpawns.RemoveAll(spawnedObject => { return spawnedObject == null; });
