...
namespace Unity.BossRoom.Gameplay.Actions
{
    public partial class FXProjectileTargetedAction
    {
        ...
        public override bool OnStartClient(ClientCharacter clientCharacter)
        {
            ...
            if (m_Target && PhysicsWrapper.TryGetPhysicsWrapper((ulong)m_Target.netId, out var physicsWrapper))
            {
        ...
        NetworkIdentity GetTarget(ClientCharacter parent)
        {
            ...
            var targetObject = NetworkIdentityUtils.FindByNetId((uint)Data.TargetIds[0]);
        ...
        public override void AnticipateActionClient(ClientCharacter clientCharacter)
        {
            ...
            if (Data.TargetIds != null && Data.TargetIds.Length > 0)
            {
                var targetObj = NetworkIdentityUtils.FindByNetId((uint)Data.TargetIds[0]);
                if (targetObj)
                {
